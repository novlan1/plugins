...
首先基于当前项目架构，搭建了 `vite` [基础配置](https://mobile.aow.com/uni-plugin-light/zh/config/vite-config.html)。
...
一个 [Vite 插件](https://mobile.aow.com/uni-plugin-light/zh/vite/cross-platform.html) 即可解决。
