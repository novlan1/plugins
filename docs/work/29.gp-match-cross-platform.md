...
Tcplayer错误码52：license对域名校验不通过。需要在腾讯云更新license，https://console.cloud.tencent.com/vcube/web?tab=player

游戏内浏览器直播组件无法全屏（暂无解决方法）

qq小程序直播只能用rtmp格式，否则无法播放

小程序需要申请“社交 - 直播”类目，并且微信小程序需要启用live-player权限

<img src="https://mike-1255355338.cos.ap-guangzhou.myqcloud.com/article/2025/8/own_mike_5XePGJddHHmj7F7y.png" width="500">
